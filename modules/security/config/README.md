...
| Name | Description |
|------|-------------|
| <a name="output_bucket_id"></a> [bucket\_id](#output\_bucket\_id) | Config delivery bucket name |
| <a name="output_recorder_name"></a> [recorder\_name](#output\_recorder\_name) | Config recorder name |
| <a name="output_role_arn"></a> [role\_arn](#output\_role\_arn) | Config service role ARN |
<!-- END_TF_DOCS -->